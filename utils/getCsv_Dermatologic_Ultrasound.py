#处理图片在Dermatologic_Ultrasound_Organize.py
import csv
import os
...
def is_image_file(filename):
    ...
    return filename.lower().endswith('.jpg') and '_mask.png' not in filename
def delfile(exit_file):
    if os.path.exists(exit_file):
        os.remove(exit_file)
def get_label(grader_father_name):
    if grader_father_name == 'BCC':
        label = '0'
    elif grader_father_name == 'CYST':
        label = '1'
    else:
        label = '2'
    return label
...
def test_gen_csv():
    ...
    image_csv_file_path = "/home/test/Uterus_Dis_Cl/Dermatologic_Ultrasound/v7_v10/all_images.csv"
    patients_csv_file_path = "/home/test/Uterus_Dis_Cl/Dermatologic_Ultrasound/v7_v10/all_patients.csv"

    # 定义图片文件夹的路径
    images_directory = "//home/test/Uterus_Dis_Cl/Dermatologic_Ultrasound/dx/"
    split_kflod_file_path= "/home/test/Uterus_Dis_Cl/Dermatologic_Ultrasound/v7_v10/"
