...
def test_gen_csv():
    ...
    image_csv_file_path = "/home/test/Uterus_Dis_Cl/dataset_thyroid/train/v7_v10/all_images.csv"
    patients_csv_file_path = "/home/test/Uterus_Dis_Cl/dataset_thyroid/train/v7_v10/all_patients.csv"

    # 定义图片文件夹的路径
    images_directory = "/home/test/Uterus_Dis_Cl/dataset_thyroid/train/"
    split_kflod_file_path= "/home/test/Uterus_Dis_Cl/dataset_thyroid/train/v7_v10"
