...
# import cv2
# images=cv2.imread("pytorch-classification-master/utils/images/cifar copy.png")
# mask=cv2.imread("pytorch-classification-master/utils/images/imagenet copy.png")
# # cv2.imshow('image', images)
# # cv2.waitKey(0)
# # cv2.destroyAllWindows()
# show_mask_single(images,mask, Mean=(2, 2, 2), Std=(0.5,0.5,0.5))