...
def get_label(grader_father_name):
    if grader_father_name == 'Normal':
        label = '0'
    elif grader_father_name == 'Stone':
        label = '1'
    elif grader_father_name == 'other':
        label = '2'
    else:
...
def test_gen_csv():
    ...
    image_csv_file_path = "/home/test/Uterus_Dis_Cl/Kidney_stone/v7_v10/all_images.csv"
    patients_csv_file_path = "/home/test/Uterus_Dis_Cl/Kidney_stone/v7_v10/all_patients.csv"

    # 定义图片文件夹的路径
    images_directory = "/home/test/Uterus_Dis_Cl/Kidney_stone"
    split_kflod_file_path= "/home/test/Uterus_Dis_Cl/Kidney_stone/v7_v10/"
