...
def DaViT_tiny(pretrained=False, **kwargs):
    model_kwargs = dict(
        patch_size=4, window_size=7, embed_dims=(96, 192, 384, 768), num_heads=((2, 4, 8, 16)),
        depths=(1, 1, 3, 1), mlp_ratio=2., overlapped_patch=pretrained, **kwargs)
    print(model_kwargs)
    return _create_transformer('DaViT_224', pretrained=pretrained, **model_kwargs)
# FLOPs: 4540244736, params: 28360168@register_model
# def DaViT_tiny(pretrained=False, **kwargs):
#     model_kwargs = dict(
#         patch_size=4, window_size=7, embed_dims=(96, 192, 384, 768), num_heads=(3, 6, 12, 24),
#         depths=(1, 1, 3, 1), mlp_ratio=4., overlapped_patch=pretrained, **kwargs)
#     print(model_kwargs)
#     return _create_transformer('DaViT_224', pretrained=pretrained, **model_kwargs)
